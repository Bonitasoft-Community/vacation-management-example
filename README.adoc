...
. Download the https://github.com/Bonitasoft-Community/vacation-management-example/releases[project .bos file and REST API extension .zip file]
...
... Go to **Resources**.
... Click on **Add** button.
... Select the `employeeVacationInformationForManager-7.9.3-1.5.zip` file.
